...
/*!********************************!*\
  ...
  \********************************/
/*! namespace exports */
/*! export SelectionType [provided] [no usage info] [missing usage info prevents renaming] */
/*! export addIntoSelections [provided] [no usage info] [missing usage info prevents renaming] */
/*! export areAllCellsSelected [provided] [no usage info] [missing usage info prevents renaming] */
/*! export areSelectionsComplex [provided] [no usage info] [missing usage info prevents renaming] */
/*! export areSelectionsNeat [provided] [no usage info] [missing usage info prevents renaming] */
/*! export cleanupSelections [provided] [no usage info] [missing usage info prevents renaming] */
/*! export cloneSelections [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getIntersection [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getSelectedContiguousColumns [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getSelectedContiguousRows [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getSelectionBounds [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getSelectionFromString [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getSelectionStateFromCells [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getVerboseSelectionStateFromCells [provided] [no usage info] [missing usage info prevents renaming] */
/*! export isCellSelected [provided] [no usage info] [missing usage info prevents renaming] */
/*! export isColumnSelected [provided] [no usage info] [missing usage info prevents renaming] */
/*! export isRowSelected [provided] [no usage info] [missing usage info prevents renaming] */
/*! export mergeSelections [provided] [no usage info] [missing usage info prevents renaming] */
/*! export moveSelections [provided] [no usage info] [missing usage info prevents renaming] */
/*! export normalizeSelection [provided] [no usage info] [missing usage info prevents renaming] */
/*! export removeFromSelections [provided] [no usage info] [missing usage info prevents renaming] */
/*! export removePartOfCellsSelection [provided] [no usage info] [missing usage info prevents renaming] */
/*! export removePartOfColumnsSelection [provided] [no usage info] [missing usage info prevents renaming] */
/*! export removePartOfRowsSelection [provided] [no usage info] [missing usage info prevents renaming] */
/*! export shrinkOrExpandSelections [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_require__.r, __webpack_exports__, __webpack_require__.d, __webpack_require__.* */
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
